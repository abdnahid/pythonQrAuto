...
for i, x in data.iterrows():
    ...
    for j, y in enumerate(capacity):
        table_row_data += f'<tr style="text-align: center;"><td style="width: 8%;text-align: center; border: 0.5px solid #000000;">{En2Bn(str(j+1)).translate()}</td><td style="width: 20%;text-align: center; border: 0.5px solid #000000;"><p>ডিজিটাল ওয়েট স্কেল</p></td><td style="width: 10%; text-align: center; border: 0.5px solid #000000;">{y}</td><td style="width: 10%; border: 0.5px solid #000000;">{quantity[j]}</td><td style="width: 15%;text-align: center; border: 0.5px solid #000000;">-</td><td style="width: 10%;text-align: center; border: 0.5px solid #000000;">-</td><td style="width: 20%;text-align: center; border: 0.5px solid #000000;">{fees[j]}</td></tr>'
    time.sleep(1)
    ...
    time.sleep(1)
    driver.find_element(By.ID, "verification_date").send_keys("31-08-23")
